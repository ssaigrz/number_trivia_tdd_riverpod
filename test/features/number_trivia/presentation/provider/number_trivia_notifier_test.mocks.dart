...
// in number_trivia_tdd_riverpod/test/features/number_trivia/presentation/provider/number_trivia_notifier_test.dart.
...
import 'package:number_trivia_tdd_riverpod/core/error/failures.dart' as _i6;
import 'package:number_trivia_tdd_riverpod/core/usecases/usecase.dart' as _i9;
...
class MockInputConverter extends _i1.Mock implements _i10.InputConverter {
  ...
  @override
  _i3.Either<_i6.Failure, num> stringToUnsignedNumber(String? str) =>
      (super.noSuchMethod(Invocation.method(#stringToUnsignedNumber, [str]),
              returnValue: _FakeEither_1<_i6.Failure, num>())
          as _i3.Either<_i6.Failure, num>);
  @override
  String toString() => super.toString();
}
